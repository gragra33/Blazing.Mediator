...
public class MediatorTelemetryStreamingTests : IDisposable
{
    ...
    public MediatorTelemetryStreamingTests()
    {
        ...
        services.AddScoped<IStreamRequestHandler<StreamingTestStreamRequest, string>, TestStreamHandler>();
        services.AddScoped<IStreamRequestHandler<StreamingTestStreamRequestWithException, string>, TestStreamHandlerWithException>();
