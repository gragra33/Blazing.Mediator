...
public class TestRegistrationQueryHandler : IRequestHandler<TestRegistrationQuery, string>
{
    ...
    public ValueTask<string> Handle(TestRegistrationQuery request, CancellationToken cancellationToken = default)
    {
        return ValueTask.FromResult("TestRegistrationQueryHandler");
    }
}